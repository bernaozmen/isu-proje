...
<body>
    <form id="form1" runat="server">
        <div>
             <div style="font-size:x-large" align="center">İSU İletişim Formu Bilgileri</div>
            <br />
            <br />
             <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>&nbsp;<asp:Label runat="server" Width="100px" ForeColor="White" ID="ctl131" BackColor="White"></asp:Label>
                        <asp:Button ID="Button1" runat="server" Text="Insert" ForeColor="White" Font-Size="Medium" BorderColor="#9933FF" BackColor="#9933FF" OnClick="Button1_Click"></asp:Button>
                        <asp:Button ID="Button2" runat="server" Text="Update" ForeColor="White" Font-Size="Medium" BorderColor="#9933FF" BackColor="#9933FF" OnClick="Button2_Click"></asp:Button>
                        <asp:Button ID="Button3" runat="server" Text="Delete" ForeColor="White" Font-Size="Medium" BorderColor="#9933FF" BackColor="#9933FF" OnClick="Button3_Click"></asp:Button>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;<asp:GridView runat="server" Width="500px" ID="GridView1"></asp:GridView>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
